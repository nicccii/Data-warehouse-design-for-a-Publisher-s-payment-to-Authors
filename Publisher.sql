...
(
   loc_id         char(20)           NOT NULL

         CONSTRAINT UPKCL_pubind PRIMARY KEY CLUSTERED

         CHECK (loc_id in ('1389', '0736', '0877', '1622', '1756')
            OR loc_id like '99[0-9][0-9]'),
...
raiserror('Now at the inserts to locations ....',0,1)

GO

insert locations values('0736', 'Boston', 'MA', 'USA')
insert locations values('0877', 'Washington', 'DC', 'USA')
insert locations values('1389', 'Berkeley', 'CA', 'USA')
insert locations values('9952', 'New York', 'NY', 'USA')
insert locations values('1622', 'Chicago', 'IL', 'USA')
insert locations values('1756', 'Dallas', 'TX', 'USA')
insert locations values('9901', 'MÅunich', NULL, 'Germany')
insert locations values('9999', 'Paris', NULL, 'France')
...
insert titles (title_id, title, type, loc_id, notes) values('PC9999', 'Net Etiquette',
...
insert sales values('7066', 'QA7442.3', '09/13/20', 75, 'ON invoice','PS2091')
insert sales values('7067', 'D4482', '09/14/20', 10, 'Net 60','PS2091')
insert sales values('7131', 'N914008', '09/14/20', 20, 'Net 30','PS2091')
insert sales values('7131', 'N914014', '09/14/20', 25, 'Net 30','MC3021')
insert sales values('8042', '423LL922', '09/14/20', 15, 'ON invoice','MC3021')
insert sales values('8042', '423LL930', '09/14/20', 10, 'ON invoice','BU1032')
insert sales values('6380', '722a', '09/13/20', 3, 'Net 60','PS2091')
insert sales values('6380', '6871', '09/14/20', 5, 'Net 60','BU1032')
insert sales values('8042','P723', '08/11/20', 25, 'Net 30', 'BU1111')
insert sales values('7896','X999', '08/21/20', 35, 'ON invoice', 'BU2075')
insert sales values('7896','QQ2299', '08/28/20', 15, 'Net 60', 'BU7832')
insert sales values('7896','TQ456', '08/12/20', 10, 'Net 60', 'MC2222')
insert sales values('8042','QA879.1', '08/22/20', 30, 'Net 30', 'PC1035')
insert sales values('7066','A2976', '08/24/20', 50, 'Net 30', 'PC8888')
insert sales values('7131','P3087a', '08/29/20', 20, 'Net 60', 'PS1372')
insert sales values('7131','P3087a', '08/29/20', 25, 'Net 60', 'PS2106')
insert sales values('7131','P3087a', '08/29/20', 15, 'Net 60', 'PS3333')
insert sales values('7131','P3087a', '08/29/20', 25, 'Net 60', 'PS7777')
insert sales values('7067','P2121', '08/15/20', 40, 'Net 30', 'TC3218')
insert sales values('7067','P2121', '08/15/20', 20, 'Net 30', 'TC4203')
insert sales values('7067','P2121', '08/15/20', 20, 'Net 30', 'TC7777')
...
insert employee values ('PTC11962M', 'Philip', 'Cramer', 2, 215, '9952')
insert employee values ('AMD15433F', 'Ann', 'Devon', 3, 200, '9952')
insert employee values ('F-C16315M', 'Francisco', 'Chang', 4, 227, '9952')
insert employee values ('LAL21447M', 'Laurence', 'Lebihan', 5, 175, '0736')
insert employee values ('PXH22250M', 'Paul', 'Henriot', 5, 159, '0877')
insert employee values ('SKO22412M', 'Sven', 'Ottlieb', 5, 150, '1389')
insert employee values ('RBM23061F', 'Rita', 'Muller', 5, 198, '1622')
insert employee values ('MJP25939M', 'Maria', 'Pontes', 5, 246, '1756')
insert employee values ('JYL26161F', 'Janine', 'Labrune', 5, 172, '9901')
insert employee values ('CFH28514M', 'Carlos', 'Hernadez', 5, 211, '9999')
insert employee values ('VPA30890F', 'Victoria', 'Ashworth', 6, 140, '0877')
insert employee values ('L-B31947F', 'Lesley', 'Brown', 7, 120, '0877')
insert employee values ('ARD36773F', 'Anabela', 'Domingues', 8, 100, '0877')
insert employee values ('M-R38834F', 'Martine', 'Rance', 9, 75, '0877')
insert employee values ('PHF38899M', 'Peter', 'Franken', 10, 75, '0877')
insert employee values ('DBT39435M', 'Daniel', 'Tonini', 11, 75, '0877')
insert employee values ('H-B39728F', 'Helen', 'Bennett', 12, 35, '0877')
insert employee values ('PMA42628M', 'Paolo', 'Accorti', 13, 35, '0877')
insert employee values ('ENL44273F', 'Elizabeth', 'Lincoln', 14, 35, '0877')

GO

insert employee values ('MGK44605M', 'Matti', 'Karttunen', 6, 220, '0736')
insert employee values ('PDI47470M', 'Palle', 'Ibsen', 7, 195, '0736')
insert employee values ('MMS49649F', 'Mary', 'Saveley', 8, 175, '0736')
insert employee values ('GHT50241M', 'Gary', 'Thomas', 9, 170, '0736')
insert employee values ('MFS52347M', 'Martin', 'Sommer', 10, 165, '0736')
insert employee values ('R-M53550M', 'Roland', 'Mendel', 11, 150, '0736')
insert employee values ('HAS54740M', 'Howard', 'Snyder', 12, 100, '0736')
insert employee values ('TPO55093M', 'Timothy', 'O''Rourke', 13, 100, '0736')
insert employee values ('KFJ64308F', 'Karin', 'Josephs', 14, 100, '0736')
insert employee values ('DWR65030M', 'Diego', 'Roel', 6, 192, '1389')
insert employee values ('M-L67958F', 'Maria', 'Larsson', 7, 135, '1389')
insert employee values ('PSP68661F', 'Paula', 'Parente', 8, 125, '1389')
insert employee values ('MAS70474F', 'Margaret', 'Smith', 9, 78, '1389')
insert employee values ('A-C71970F', 'Aria', 'Cruz', 10, 87, '1389')
insert employee values ('MAP77183M', 'Miguel', 'Paolino', 11, 112, '1389')
insert employee values ('Y-L77953M', 'Yoshi', 'Latimer', 12, 32, '1389')
insert employee values ('CGS88322F', 'Carine', 'Schmitt', 13, 64, '1389')
insert employee values ('PSA89086M', 'Pedro', 'Afonso', 14, 89, '1389')
insert employee values ('A-R89858F', 'Annette', 'Roulet', 6, 152, '9999')
insert employee values ('HAN90777M', 'Helvetius', 'Nagy', 7, 120, '9999')
insert employee values ('M-P91209M', 'Manuel', 'Pereira', 8, 101, '9999')
insert employee values ('KJJ92907F', 'Karla', 'Jablonski', 9, 170, '9999')
insert employee values ('POK93028M', 'Pirkko', 'Koskitalo', 10, 80, '9999')
insert employee values ('PCM98509F', 'Patricia', 'McKenna', 11, 150, '9999')
GO
